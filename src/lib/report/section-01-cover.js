 ...
 */
import { rankDimensions, DIM_ORDER, DIM_COLORS, DIM_SHORT, formatScore, levelLabel } from './helpers.js';

export function generateCover(results, name) {
