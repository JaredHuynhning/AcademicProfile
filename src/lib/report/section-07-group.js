...
import { analyzeCX, analyzeEA, analyzeHA } from './combinations.js';

export function generateGroup(results) {
...
function buildCommunicationStyle(dims) {
...
function buildConflictHandling(dims) {
...
function buildBestPartners(dims) {
	const partners = [];
