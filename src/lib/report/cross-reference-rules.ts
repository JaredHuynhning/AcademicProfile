...
export interface AcademicCondition {
	source: 'studyProfile' | 'learnerProfile';
	path: string;
	op: '>=' | '<' | '=';
	threshold: number;
}
...
export interface CrossRefRule {
	id: string;
	type: 'root_cause' | 'confirmation' | 'contradiction';
	personalityCondition: PersonalityCondition;
	academicCondition: AcademicCondition;
	insight: string;
	action: string;
	audience: string;
...
export interface UntappedEntry {
	personalityCondition: PersonalityCondition;
	academicCondition: AcademicCondition;
	untappedInsight: string;
	untappedAction: string;
}

export const ROOT_CAUSE_RULES: CrossRefRule[] = [
	{
		id: 'rc-01',
		type: 'root_cause',
...
export const CONFIRMATION_RULES: CrossRefRule[] = [
	{
		id: 'cf-01',
		type: 'confirmation',
...
export const CONTRADICTION_RULES: CrossRefRule[] = [
	{
		id: 'cx-01',
		type: 'contradiction',
		personalityCondition: { dim: 'C', op: '>=', threshold: 3.5 },
...
export const UNTAPPED_MAPPING: UntappedEntry[] = [
	{
		personalityCondition: { facet: 'diligence', dim: 'C', op: '>=', threshold: 3.5 },
...
export const ALL_RULES: CrossRefRule[] = [...ROOT_CAUSE_RULES, ...CONFIRMATION_RULES, ...CONTRADICTION_RULES];
