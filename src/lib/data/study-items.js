/**
 * 30 Study/Motivation/Self-Regulation items (IDs 61-90).
 * Based on ASSIST, AMS, MSLQ, MES validated instruments.
 * All use 1-5 Likert scale (same as HEXACO): Strongly Disagree → Strongly Agree.
 * First-person, school-context phrasing.
 *
 * Scoring metadata:
 *   domain    – 'studyApproaches' | 'motivation' | 'selfRegulation'
 ...
 */
export const studyItemMap = Object.fromEntries(studyItems.map((item) => [item.id, item]));
